...
#if PURPLE_VERSION_CHECK(3, 0, 0) /* purple_util_fetch_url_len will be removed with 3.0.0 */
        gfire_update_data = purple_util_fetch_url(GFIRE_CURRENT_VERSION_XML_URL, TRUE, "purple-xfire", TRUE, 1024,
                                                  gfire_update_cb, gfire_get_connection(p_gfire));
#elif PURPLE_VERSION_CHECK(2, 10, 8) /* 2.10.8 introduced size restrictions in responses */
        gfire_update_data = purple_util_fetch_url_len(GFIRE_CURRENT_VERSION_XML_URL, TRUE, "purple-xfire", TRUE, 1024,
                                                      gfire_update_cb, gfire_get_connection(p_gfire));
#else
